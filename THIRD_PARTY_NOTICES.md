...
Close Seal may integrate optional map-authoring providers. They are not vendored by the current revision unless their source/binaries appear under `addons/` beyond the project-owned `close_seal_map_forge` addon.

Reviewed upstream code licenses:
...
When a provider is vendored or pinned, preserve its copyright/license notice and record the exact revision used here or in a dependency lock manifest.
